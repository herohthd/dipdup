...
const renderTypeMap = (schema, ctx) => {
    ...
    Object.keys(schema.getTypeMap())
        ...
        if (graphql_1.isObjectType(t) || graphql_1.isInterfaceType(t) || graphql_1.isInputObjectType(t))
            result.types[t.name] = objectType_1.objectType(t, ctx);
        else if (graphql_1.isUnionType(t))
            result.types[t.name] = unionType_1.unionType(t, ctx);
    ...
    if ((q === null || q === void 0 ? void 0 : q.name) && (q === null || q === void 0 ? void 0 : q.name) !== 'Query') {
        ...
        result.types.Query = objectType_1.objectType(q, ctx);
    ...
    if ((m === null || m === void 0 ? void 0 : m.name) && m.name !== 'Mutation') {
        ...
        result.types.Mutation = objectType_1.objectType(m, ctx);
    ...
    if ((s === null || s === void 0 ? void 0 : s.name) && s.name !== 'Subscription') {
        ...
        result.types.Subscription = objectType_1.objectType(s, ctx);
