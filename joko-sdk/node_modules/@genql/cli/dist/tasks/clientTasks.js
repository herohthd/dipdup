...
const renderChainTypes_1 = require("../render/chain/renderChainTypes");
    ...
    const tasks = [
        {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield files_1.writeFileToPath([output, schemaGqlFile], renderCtx.toCode('graphql'));
            }),
        },
        {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield files_1.writeFileToPath([output, schemaTypesFile], renderCtx.toCode('typescript'));
            }),
        },
        !config.onlyCJSModules && {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                const renderCtx = new RenderContext_1.RenderContext(ctx.schema, config);
                renderTypeGuards_1.renderTypeGuards(ctx.schema, renderCtx, 'esm');
                yield files_1.writeFileToPath([output, guardsFileEsm], renderCtx.toCode('typescript'));
            }),
        },
        !config.onlyEsModules && {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                const renderCtx = new RenderContext_1.RenderContext(ctx.schema, config);
                renderTypeGuards_1.renderTypeGuards(ctx.schema, renderCtx, 'cjs');
                yield files_1.writeFileToPath([output, guardsFileCjs], renderCtx.toCode('typescript'));
            }),
        },
        {
            title: `writing types`,
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (!config.onlyEsModules) {
                    yield files_1.writeFileToPath([output, typeMapFileCjs], `module.exports = ${renderCtx.toCode()}`);
                }
                if (!config.onlyCJSModules) {
                    yield files_1.writeFileToPath([output, typeMapFileEsm], `export default ${renderCtx.toCode()}`);
                }
            }),
        },
        !config.onlyEsModules && {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                const renderCtx = new RenderContext_1.RenderContext(ctx.schema, config);
                renderClient_1.renderClientCjs(ctx.schema, renderCtx);
                yield files_1.writeFileToPath([output, clientFileCjs], renderCtx.toCode('typescript', true));
            }),
        },
        !config.onlyCJSModules && {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                const renderCtx = new RenderContext_1.RenderContext(ctx.schema, config);
                renderClient_1.renderClientEsm(ctx.schema, renderCtx);
                yield files_1.writeFileToPath([output, clientFileEsm], renderCtx.toCode('typescript', true));
            }),
        },
        {
            ...
            task: (ctx) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield files_1.writeFileToPath([output, clientTypesFile], renderCtx.toCode('typescript', true));
            }),
        },
    ];
    return [
        {
            ...
            task: () => files_1.ensurePath([output], true),
        },
        {
            title: `writing files`,
